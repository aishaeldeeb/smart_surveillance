...
parser.add_argument('--rgb-list', default='list/train_i3d_list.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/test_i3d_list.list', help='list of test rgb features ')
...
parser.add_argument('--max-epoch', type=int, default=1500, help='maximum iteration to train (default: 100)')
