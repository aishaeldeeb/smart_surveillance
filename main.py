...
if __name__ == '__main__':
    ...
    # train_nloader = DataLoader(Dataset(args, test_mode=False, transform = transform, is_normal=True),
    #                            batch_size=args.batch_size, shuffle=True,
    #                            num_workers=0, pin_memory=False, drop_last=True)
    


    # train_aloader = DataLoader(Dataset(args, test_mode=False, transform = transform, is_normal=False),
    #                            batch_size=args.batch_size, shuffle=True,
    #                            num_workers=0, pin_memory=False, drop_last=True)
